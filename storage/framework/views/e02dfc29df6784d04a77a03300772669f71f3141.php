            ...
            <div class="container-fluid fixed">
                <div class="row">
                    <div class="col-md-12">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            <a class="navbar-brand" href="index.php">VTC SP</a>
                ...
                <span class="icon-menu"></span>
                     ...
                     <span class="icon-arrow-down"></span>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="contacto.php">Verificación de VTC</a>
                                    </li>
                                      <li class="nav-item active">
                                        <a class="nav-link" href="nosotros.php">Sobre Nosotros</a>
                                    </li>
                                    <li><a href="login" class="btn btn-outline-light top-btn"><span class="ti-plus"></span>Login</a></li>
                                </ul>
                            </div>
                        </nav>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="slider-content_wrap">
                                    <img src="images/vtc.png" style="height: 30%" width="30%">
...
<footer class="main-block dark-bg">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="copyright">
                        <p>Esta aplicación fue realizada por Diego Abdul, Zoran Cerrillo, Laura Vizcaíno y Diego Gil derechos reservados &copy;</a></p>
                        <ul>
                            <p>Diego Abdul</p>
