        ...
        <nav class="navbar navbar-default navbar-fixed-top">
          <div class="container">
            <div class="navbar-header">
              <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#KeniaMenu">
                <span class="icon-bar"></span>
                <span class="icon-bar"></span>
                <span class="icon-bar"></span>
              </button>
              <a class="navbar-brand" href="#">Kenia</a>
            </div>
            <div class="collapse navbar-collapse" id="KeniaMenu">
          ...
          <div class="row">
            <div class="col-md-12 wow fadeIn delay-05s">
              <div class="banner-text">
                <h2>Hi, I am <span>Kenia</span> Vasallo,</h2>
                <p>Artista <br>& Escultora</p>
              </div>
...
while($row = mysqli_fetch_assoc($result)) { ?>
      <div class="swiper-slide" style="background-image:(\"pache/<?php echo $row['imagen']; ?>\")
<?php $count++; } ?></div>
    <!-- Add Pagination -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 text-right">
          <h2 class="title-text">
            Meet<br><span class="deco">Kenia</span> Vasallo
          </h2>
        </div>
  ...
  <footer class="footer-2 text-center-xs bg--white">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="footer">
            © Copyright Diego Abdul. All Rights Reserved
          </div>
        </div>
        <div class="col-md-6 text-right">
